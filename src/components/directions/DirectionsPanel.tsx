    ...
    <div className="bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden flex flex-col w-[280px] max-h-[calc(100vh-32px)]">
      ...
      <div className="border-b border-gray-100 text-gray-800 p-3.5">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="p-2.5 hover:bg-gray-100 rounded-lg transition-colors flex-shrink-0 ml-2 text-gray-400 hover:text-gray-600 active:scale-95"
            aria-label="닫기"
            title="닫기"
          >
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex gap-1.5 ml-4">
              <button
                ...
                className={`flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-[11px] font-medium transition-all active:scale-95 ${departureMode === 'current'
              ...
              <button
                ...
                className={`flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-[11px] font-medium transition-all active:scale-95 ${departureMode === 'search'
                  ? 'bg-gray-800 text-white shadow-sm'
                  : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                  }`}
                aria-label="장소 검색으로 출발지 설정"
                title="검색"
              >
                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <button
                ...
                className={`flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-[11px] font-medium transition-all active:scale-95 ${departureMode === 'map' || isWaitingMapClick
                  ? 'bg-gray-800 text-white shadow-sm'
                  : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                  }`}
