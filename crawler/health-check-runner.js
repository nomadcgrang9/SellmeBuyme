...
// location: 실제 DB에 저장되는 값 패턴 (ilike 검색용) - sources.json의 region 값과 일치
const REGION_BOARDS = {
  seoul: { name: '서울', location: '서울', boardUrl: 'https://work.sen.go.kr/work/search/recInfo/BD_selectSrchRecInfo.do' },
  busan: { name: '부산', location: '부산광역시', boardUrl: 'https://www.pen.go.kr/main/na/ntt/selectNttList.do?mi=30367&bbsId=2364' },
  daegu: { name: '대구', location: '대구광역시', boardUrl: 'https://www.dge.go.kr/main/na/ntt/selectNttList.do?mi=5186&bbsId=1047' },
  ...
  daejeon: { name: '대전', location: '대전광역시', boardUrl: 'https://www.dje.go.kr/boardCnts/list.do?boardID=54&m=030202&s=dje' },
  ulsan: { name: '울산', location: '울산광역시', boardUrl: 'https://www.use.go.kr/subPage.do?page=sub06_06_01&m=0606&s=use' },
  ...
  chungbuk: { name: '충북', location: '충청북도', boardUrl: 'https://www.cbe.go.kr/cbe/na/ntt/selectNttList.do?mi=11716&bbsId=1798' },
  chungnam: { name: '충남', location: '충청남도', boardUrl: 'https://www.cne.go.kr/boardCnts/list.do?boardID=642&m=020201&s=cne' },
  ...
  jeonnam: { name: '전남', location: '전라남도', boardUrl: 'https://www.jne.go.kr/main/na/ntt/selectNttList.do?mi=265&bbsId=117' },
  gyeongbuk: { name: '경북', location: '경상북도', boardUrl: 'https://www.gbe.kr/main/na/ntt/selectNttList.do?mi=3626&bbsId=1887' },
  gyeongnam: { name: '경남', location: '경상남도', boardUrl: 'https://www.gne.go.kr/works/user/recruitment/BD_recruitmentList.do?q_searchStatus=1004' },
